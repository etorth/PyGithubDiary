...
- **Security Notice**: The default "encryption" is obfuscation only (frequency remapping + compression + base64), not cryptographically secure. Anyone with repository access can decode your diaries. Always use a **private** repository for your diaries.
